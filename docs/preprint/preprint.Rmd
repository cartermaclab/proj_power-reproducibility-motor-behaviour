...
keywords          : |
  ...
  \newline \newline \emph{Please cite as}: McKay, B., Bacelar, M. F. B., \& Carter, M.J. (2022). On the reproducibility of power analyses in motor behavior research. \emph{SportR$\chi$iv}
#wordcount         : ""
...
The preregistration, data, and code for this study can be found using either of these links: https://osf.io/9a6m8/ or https://github.com/cartermaclab/proj_power-analysis-reproducibility.
...
\noindent The preregistration, data, and code for this study can be accessed using either of these links: https://osf.io/9a6m8/ or https://github.com/cartermaclab/proj_power-analysis-reproducibility.
