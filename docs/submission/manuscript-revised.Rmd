...
table_1 <- readr::read_csv("../submission/table.csv")
```
...
The preregistration, data, and code for this study can be found using either of these links: https://osf.io/9a6m8/ \censor{or} \censor{$https://github.com/cartermaclab/proj_power-reproducibility-motor-behaviour$}.
...
kbl(table_1,
    ...
    caption = "Recommendations for ensuring reproducible power analyses"
    ) %>%
  landscape() %>%
...
\noindent The preregistration, data, and code for this study can be accessed using either of these links:  https://github.com/cartermaclab/proj_power-reproducibility-motor-behaviour or https://osf.io/9a6m8/. \textcolor{blue}{An unrefereed version of this paper can be found at https://doi.org/10.51224/SRXIV.184}
