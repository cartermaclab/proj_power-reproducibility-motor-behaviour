...
\noindent The preregistration, data, and code for this study can be accessed using either of these links: \censor{$https://github.com/cartermaclab/proj_power-reproducibility-motor-behaviour$} or \url{https://osf.io/9a6m8/}.
